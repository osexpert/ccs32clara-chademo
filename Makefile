...
EXTRACOMPILERFLAGS := $(shell \
  ...
  GITHUB_AO=$${GITHUB_AO:-0}; \
  GITHUB_SX=$${GITHUB_SX:-0}; \
  GITHUB_JDEMO=$${GITHUB_JDEMO:-0}; \
  echo "-DGITHUB_VERSION=\\\"$${DATE}-$${GITHUB_RUN_NUMBER}$${GITHUB_APPEND_VER}\\\" -DGITHUB_AV=$${GITHUB_AV} -DGITHUB_V2X=$${GITHUB_V2X} -DGITHUB_AO=$${GITHUB_AO} -DGITHUB_SX=$${GITHUB_SX} -DGITHUB_JDEMO=$${GITHUB_JDEMO}"; \
)
...
OBJSL		  = main.o hwinit.o \
				 ...
				 chademoCharger.o chademoHardware.o led_blinker.o special_modes.o stm32scheduler.o
